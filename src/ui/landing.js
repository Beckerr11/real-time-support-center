const CONTENT = {
  brand: "Real Time Support Center",
  strap: "live support",
  subtitle: "Central de suporte em tempo real com fila SLA, mensagens e eventos SSE.",
  accent: "#ff8cae",
  ctaPrimary: "Health check",
  ctaSecondary: "Fluxo em tempo real",
  apiTitle: "Support endpoints",
  featuresHtml: `<li><span>01</span><strong>Fila de atendimento com prioridade e calculo de overdue por SLA.</strong></li><li><span>02</span><strong>Eventos SSE para atualizar paineis sem polling pesado.</strong></li><li><span>03</span><strong>Fluxo completo de atribuicao, mensagens e resolucao de tickets.</strong></li>`,
  endpointsHtml: `<li><span class="method">GET</span><span class="path">/health</span></li><li><span class="method">GET</span><span class="path">/events</span></li><li><span class="method">POST</span><span class="path">/conversations</span></li><li><span class="method">GET</span><span class="path">/conversations</span></li><li><span class="method">GET</span><span class="path">/queue</span></li><li><span class="method">PATCH</span><span class="path">/conversations/:id/assign</span></li>`,
}
